...
* 
* VALIDACI�N: 
* Si no hay informaci�n en la sesi�n: Colocar nulls
* 
            ...
            ****************************/
            if ((string)req.Method == "GET")
            {
                ...
                */
                ...
                if (sesion.Count >= 3 )
                {
                    string responseMessageS = JsonConvert.SerializeObject(new { Resultado1 = sesion_orden[0] , Resultado2 = sesion_orden[1], Resultado3 = sesion_orden[2] });
                ...
                if (sesion.Count == 2)
                {
                    string responseMessageS = JsonConvert.SerializeObject(new { Resultado1 = sesion_orden[0], Resultado2 = sesion_orden[1], Resultado3 = sesionVacia[0] });
                ...
                if (sesion.Count == 1)
                {
                    string responseMessageS = JsonConvert.SerializeObject(new { Resultado1 = sesion_orden[0], Resultado2 = sesionVacia[0], Resultado3 = sesionVacia[0] });

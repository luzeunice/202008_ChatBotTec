...
namespace Microsoft.BotFramework.Composer.CustomAction_Correo
{
    /// <summary>
    ...
    /// </summary>
    public class Correo : Dialog
    {
        [JsonConstructor]
        public Correo([CallerFilePath] string sourceFilePath = "", [CallerLineNumber] int sourceLineNumber = 0)
            : base()
        {
        ...
        [JsonProperty("$kind")]
        public const string Kind = "Correo";
